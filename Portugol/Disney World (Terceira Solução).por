  ...
  funcao inicio() {
    ...
    */
    ...
    se (idade >= 10) {
      ...
      se (altura >= 1.50 e idade >= 12) {
      ...
      } senao se (altura < 1.50 e idade >= 10 e idade < 12) {
        ...
        se (idadeAcompanhante > 18) {
          ...
          escreva("Traga um acompanhante!")
        }
      } senao {
        escreva("Não pode entrar no brinquedo")
      }
    } senao {
      escreva("Desculpa, não consideramos você apto a dar um rolê aqui!")
    }
  }
}
