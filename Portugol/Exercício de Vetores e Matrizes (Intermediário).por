    ...
    */
    ...
    para (inteiro contador = 0; contador < 10; contador++) {
      ...
      se (informarSeguidor == "S") {
        ...
        se (segueAPessoa == "S") {
          seguidoresInsta[contador] = seguidor + ", seguindo"
        } senao {
          seguidoresInsta[contador] = seguidor + ", não seguindo"
        } 
      } 
    }

    para (inteiro contador = 0; contador < 10; contador++) {
      escreva(contador + 1, ". ", seguidoresInsta[contador], "\n")
    }
  }
}